...
We select to discover, how War in Ukraine is presented on Twitter, and to realize Sentiment Analysis for current twits. This subject was selected due to topicality of that information and acute social need for such an analysis.
